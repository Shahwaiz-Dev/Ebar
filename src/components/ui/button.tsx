...
const buttonVariants = cva(
  "inline-flex items-center justify-center gap-2 whitespace-nowrap rounded-xl text-sm font-medium ring-offset-background transition-smooth focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50 [&_svg]:pointer-events-none [&_svg]:size-4 [&_svg]:shrink-0",
  {
    variants: {
      variant: {
        default: "bg-primary text-primary-foreground hover:bg-primary/90 shadow-soft hover:shadow-medium transform hover:-translate-y-0.5",
        destructive:
        ...
        ocean: "gradient-ocean text-white hover:opacity-90 shadow-medium hover:shadow-strong transform hover:-translate-y-1",
        sunset: "gradient-sunset text-white hover:opacity-90 shadow-medium hover:shadow-strong transform hover:-translate-y-1",
        hero: "gradient-sunset text-white hover:opacity-90 shadow-glow hover:shadow-strong transform hover:-translate-y-1 px-8 py-3 text-lg font-semibold",
        glass: "bg-white/10 backdrop-blur-md border border-white/20 text-white hover:bg-white/20 shadow-medium hover:shadow-strong",
      },
      size: {
